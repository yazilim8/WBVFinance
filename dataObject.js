module.exports.data = {
  header: [
    ...
    {
      name: 'COMPANY INTERIM MANAGEMENT',
    },
    {
  ...
  hero: {
    text: 'We offer only <strong> the best finance solutions </strong>',
  },
  about: {
    title: 'About Us',
    content:
      'WBV is an interim management firm changing and building up the businesses of its Clients that are the owners of mid-size and larger companies. Unlike the regular strategy or operations consultancy, we have successfully taken our intellectual products to implementation, resolving all sorts of issues on the way.  <br> <br>Though we mostly operate in Ukraine, we are nevertheless highly interested in developing cooperation with Clients from other countries.',
    redirect: {
      text: 'About WBV FINANCE ',
      href: '/',
    },
    subtitle: 'Our Brands',
  },
  sectiona: {
    title: 'COMPANY INTERIM MANAGEMENT',
    content:
      'WBV is an interim management firm changing and building up the businesses of its Clients that are the owners of mid-size and larger companies. Unlike the regular strategy or operations consultancy, we have successfully taken our intellectual products to implementation, resolving all sorts of issues on the way.  <br> <br>Though we mostly operate in Ukraine, we are nevertheless highly interested in developing cooperation with Clients from other countries.',
    redirect: {
      text: 'About WBV FINANCE ',
  ...
  sectionb: {
    title: 'PROJECT EVALUATION, CONCEPT OR STRATEGY DEVELOPMENT',
    content:
  ...
  footer: {
    ...
    contact: [
      ...
      },
      {
        ...
        text: 'Pushkova Victory',
      },
      {
        name: 'Call us',
        text: '+380-675-800-011',
      },
      {
        name: 'Email us',
        text: 'pushkova.victory@gmail.com ',
      },
    ],
    social: [
      {
